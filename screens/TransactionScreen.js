...
export default class TransactionScreen extends React.Component {
  ...
  initiateBookIssue = async ()=>{
    ...
    db.collection("Student").doc(this.state.scannedStudentId).update({
      ...
      'numberOfLoans' : firebase.firestore.FieldValue.increment(1)
  ...
  checkEligibililtyForLoan = async () => 
  {
    ...
    if(studentRef.docs.length = 0)
    {
      ...
      this.setState(
        ...
        Alert.alert("This student ID doesn't exist")
    }
    else
    {
      studentRef.docs.map(doc => 
        {
          ...
          else
          {
            ...
            Alert.alert("Student has already reached the limit for the number of loans")
  ...
  checkEligibililtyForReturn = async () => 
  {
    ...
    transactionRef.docs.map(doc => 
      {
        ...
        {
          isStudentEligible = false
          Alert.alert("Student cannot return book that is not loaned to them")
  ...
  handleTransaction = async()=>
  {
    ...
    if(!transactionType)
    {
      Alert.alert("This book doesn't exist in this library !")
      this.setState(
        {
          scannedBookId : '',
          scannedStudentId : ''
    ...
    {
      var isStudentEligible = await this.checkEligibililtyForLoan()
    ...
    {
     var isStudentEligible = await this.checkEligibililtyForReturn()
